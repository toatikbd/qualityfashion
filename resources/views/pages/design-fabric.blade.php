@extends('layouts.app')
@section('title', 'We Design Fabric')
@section('content')
            ...
            <div class="col-lg-8 content-area">
                <div class="ttm-service-single-content-area">
                    <div class="ttm-service-description">
                        <h3>Manufacturer of Design fabrics services</h3>
                        ...
                        <div class="padding_top20 padding_bottom20">
                            <div class="ttm_fatured_image-wrapper">
                                <img class="img-fluid" src="{{ asset('webasset')}}/images/services/services-06-1200x800.jpg" alt="services-6">
                            </div>
                        </div>
